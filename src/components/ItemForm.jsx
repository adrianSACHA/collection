              ...
              <div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`min-h-[44px] flex-1 rounded-lg px-4 py-2 font-medium transition-colors lg:min-h-[40px] ${
                      v.typ === 'moneta'
              ...
              {isBanknote ? (
                <div className="grid gap-3 sm:grid-cols-2">
                  <FormField
                    label="Miasto"
                    htmlFor="miasto"
                    hint="Wyświetlane na dole listy"
                  >
                    <input
                      id="miasto"
                      type="text"
                      value={v.miasto || ''}
                      onChange={(event) =>
                        setField('miasto', event.target.value)
                      }
                  ...
                  >
                    <input
                      ...
                      placeholder="np. Hessische Landesbank"
                      className={`${inputClass} ${
              ...
              <section className="space-y-4 rounded-xl border border-gray-200 bg-white p-4">
                ...
                <fieldset>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <label
                      className={`flex min-h-[44px] cursor-pointer items-center justify-center rounded-lg border px-3 py-2 text-sm font-medium transition-colors ${
                        !v.gwiazdka_przed && !v.gwiazdka_za
                ...
                <div className="grid gap-2 sm:grid-cols-2">
                  {rarityOptions.map((option) => {
                    ...
                    return (
                      <label
                        key={option.value}
                        className={`flex min-h-[52px] cursor-pointer items-center gap-3 rounded-lg border p-3 transition-colors ${
                          isSelected
